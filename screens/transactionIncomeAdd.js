...
const transactionIncomeAdd = ({ navigation }) => {
    ...
    <View style={styles.container}>
      ...
      <View
        ...
        <TextInput
          ...
          value={type}
          placeholder="Chọn phân loại thu nhập"
          onPressIn={() => setModalVisible(!modalVisible)}
        />
        <View style={styles.labelHeader}>
          <Text style={styles.label}>Số tiền thu nhập</Text>
          <Text style={styles.errorMessage}>
            {' '}
...
export default transactionIncomeAdd;
